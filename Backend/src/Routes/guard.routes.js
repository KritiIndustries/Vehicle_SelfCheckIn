...
import { approveEntry, checkoutVehicle, getCheckedinDetails, rejectVehicle, uploadNumberPlate, getEditedDocuments } from "../Controllers/guard.controller.js";
...
router.get('/edited-docs/:id', getEditedDocuments);
